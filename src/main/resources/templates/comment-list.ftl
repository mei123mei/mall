        ...
        <div class="layui-card">
            <div class="layui-card-body ">
                ...
                <div class="layui-inline layui-show-xs-block">
                    <input type="text" id="kw" name="keyword" value="" placeholder="根据用户名查询" autocomplete="off"
                           class="layui-input">
                </div>
                <div class="layui-inline layui-show-xs-block">
                ...
                <div class="layui-inline layui-show-xs-block">
                    <input type="text" id="kw" name="keyword" value="" placeholder="根据商品id查询" autocomplete="off"
                           class="layui-input">
                </div>
                <div class="layui-inline layui-show-xs-block">
                    <button class="layui-btn" id="searchButton" lay-submit="" lay-filter="sreach"><i
            ...
            <div class="layui-card-body">
                <table class="layui-table layui-form">
                    ...
                    <tbody id="content">
                    <#list list as comments>
                        <tr>
                            <td>${comments.id}</td>
                            <td>${comments.username}</td>
                            <td>${comments.info}</td>
                            <td>${comments.time}</td>
                            <td>${comments.itemid}</td>
            ...
            <div class="page" style="text-align: center">
                <ul class="pagination">
                    <li class="disabled"><#if data.prePage==0><a id="a1" href="/comment?pageNum=1">上一页</a> <#else><a
                            href="/comment?pageNum=${data.prePage}">上一页</a></#if></li>
                    <#if (data.curPage<2)>
                        <li class="active"><a href="/comment?pageNum=1">1</a></li>
                        <li><a href="/comment?pageNum=2">2</a></li>
                        <li><a href="/comment?pageNum=3">3</a></li>

                        <#if (data.curPage>=data.pages)>
                            <li class="active"><a href="/comment?pageNum=${data.pages-2}">${data.pages-2}</a></li>
                            <li><a href="/comment?pageNum=${data.pages-1}">${data.pages-1}</a></li>
                            <li><a href="/comment?pageNum=${data.pages}">${data.pages}</a></li>
                        </#if>

                    <#else>
                        <li class="active"><a href="/comment?pageNum=${data.prePage}">${data.prePage}</a></li>
                        <li><a href="/comment?pageNum=${data.curPage}">${data.curPage}</a></li>
                        <li><a href="/comment?pageNum=${data.nextPage}">${data.nextPage}</a></li>
                    </#if>

                    <#--							<li><a href="javascript:;">4</a></li> -->
                    <li><#if (data.nextPage>data.pages||data.nextPage==0)><a href="/comment?pageNum=${data.pages}">
                                下一页</a> <#else><a href="/comment?pageNum=${data.nextPage}">下一页</a></#if></li>
                </ul>
            </div>
        </div>
    </div>
